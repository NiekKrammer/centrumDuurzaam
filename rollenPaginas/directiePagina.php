...
<body>
    ...
    <div id="directieContainer">
        ...
        <div class="directieLinkDivs" ><h2>Kledingstukken</h2><p>Overzicht van de kledingstukken</p><a class="directieLinkButton" href="./kledingPagina.php">Ga naar kledingstukken</a></div>
